package com.tobadigitalstudio.inventory.camera;
...
public class CameraBarcodeActivity extends AppCompatActivity {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(CameraBarcodeActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(CameraBarcodeActivity.this, new
